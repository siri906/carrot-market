...
export default function LikeButton({ isLiked, likeCount, postId }: Props) {
  ...
  return (
    <button onClick={onClick} className={`flex items-center gap-2 text-neutral-400 text-sm border border-neutral-400 rounded-full p-2  transition-colors ${state.isLiked ? "bg-orange-500 text-white" : "hover:bg-neutral-800"}`}>
